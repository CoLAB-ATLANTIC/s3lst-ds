...
config = Sentinel3Config(
    out_dir=Path("/home/elio/projects/lst_downscaling/assets/data/raw/sentinel3_trial"),
    timeliness="NT",
    start_sensing_dates=[
        "20200530T093807",
        # "20200615T092312",
    ...
    geometry_aoi=Path("/home/elio/projects/lst_downscaling/assets/aoi/clim4cities.shp"),
    geometry_query=None,
    cloud_cover_lims=(0, 100),
    relative_orbit=CLIM4CITIES_REL_ORBIT,
    orbit_dir=["DESCENDING"],
    cloud_cover_max_aoi=5,
    process=True,
