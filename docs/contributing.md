...
- Render HTML in a local development server from the source documenting code at the
  [/docs](https://github.com/CoLAB-ATLANTIC/s3lst-ds/tree/main/docs) folder and
  auto-reload for changes in it:
